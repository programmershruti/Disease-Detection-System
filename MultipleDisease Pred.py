# -*- coding: utf-8 -*-
"""
Created on Sat Feb 11 21:56:04 2023
...
diabetes_model = pickle.load(open('C:/Users/shrut/Desktop/Multiple Disesase Detection System/saved models/data.sav', 'rb'))

heart_disease_model = pickle.load(open('C:/Users/shrut/Desktop/Multiple Disesase Detection System/saved models/heart.sav', 'rb'))

parkinsons_model = pickle.load(open('C:/Users/shrut/Desktop/Multiple Disesase Detection System/saved models/parkinsons_model.sav', 'rb'))

Liver_model = pickle.load(open('C:/Users/shrut/Desktop/Multiple Disesase Detection System/saved models/data (1).sav', 'rb'))
...
with st.sidebar:
    ...
    selected = option_menu('Multiple Disease Prediction System',
                          ...
                          ['Diabetes Prediction',
                           ...
                           'Parkinsons Prediction','Liver Prediction'],
...
if (selected == 'Diabetes Prediction'):
    ...
    with col1:
        Pregnancies = st.text_input('Number of Gravidity')
...
if (selected == 'Liver Prediction'):
    ...
    with col2:
        Gender = st.text_input('Gender(Female=1,male=0)')
